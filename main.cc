...
*/
CGA_Screen::Attribute k0(CGA_Screen::color::LIGHT_GREY, CGA_Screen::color::BLACK, false);
CGA_Screen::Attribute c0(CGA_Screen::color::BLACK, CGA_Screen::color::BROWN, false);
CGA_Screen::Attribute c1(CGA_Screen::color::LIGHT_GREY, CGA_Screen::color::BLUE, false);
