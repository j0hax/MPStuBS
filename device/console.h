 ...
 *
 *  Mit dem Programm `screen` kann ein Terminal unter Angabe der Schnittstelle
 *  sowie Verbindungsgeschwindigkeit geöffnet werden, z.B. mit
...
public:
   ...
   */
  Console(Serial::comPort port = COM1, Serial::baudRate baudrate = BAUD_115200,
          Serial::dataBits databits = DATA_8BIT, Serial::stopBits stopbits = STOP_1BIT,
